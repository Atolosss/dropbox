...
//            .ignoringFields("lastName", "firstName", "dateOfBirth")
...
//            .get()
//            .usingRecursiveComparison()
//            .ignoringFields("audit", "dateOfBirth")
...
//
//    @Test
//    void exceptionUserTest() {
//        final ServiceException exception = assertThrows(ServiceException.class, () -> {
//            userService.getUser(3L);
//        });
//        assertThat(exception.getMessage()).isEqualTo("User with this id User with this id %s not found not found");
//    }
}
